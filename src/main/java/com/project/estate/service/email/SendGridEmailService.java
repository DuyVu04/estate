...
/**
 * Secondary low-level SendGrid MailService implementation using SendGrid REST API.
    ...
    private void sendSendGridMail(String to, String subject, Content content, MultipartFile[] files) {
            ...
            for (MultipartFile file : files) {
                if (file != null && !file.isEmpty()) {
                    try {
                        ...
                        log.error("[SENDGRID] Failed to attach file {}: {}", file.getOriginalFilename(), e.getMessage());
                    }
                }
            }
        }
        ...
        try {
            ...
            if (response.getStatusCode() == 202) {
                ...
                log.error("[SENDGRID] Failed to send email to {}. Status: {}, Body: {}",
