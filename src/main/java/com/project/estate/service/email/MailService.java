...
/**
 * Clean low-level email sender contract (Interface Segregation & Liskov Substitution). Focuses
 * purely on transport delivery (Text, HTML, Attachments) without domain template coupling.
 */
