...
/**
 * Responsible for rendering Thymeleaf HTML templates and delegating transport delivery to the
 * low-level MailService interface.
 */
@Service
...
public class EmailTemplateService {
  ...
  public void sendDepositPaidEmail(
      String to,
    ...
    log.info(
        "[TEMPLATE_SERVICE] Rendering deposit paid template for reservationId={}, email={}",
        reservationId,
        to);
