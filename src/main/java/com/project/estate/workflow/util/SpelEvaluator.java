...
/**
 * Utility Component responsible for evaluating Spring SpEL expressions to extract target entity
 * IDs.
 */
@Slf4j
@Component
public class SpelEvaluator {
  ...
  public String parseTargetId(JoinPoint joinPoint, String spel, Object result) {
    ...
    try {
      ...
      log.debug(
          "[SPEL_EVALUATOR] SpEL evaluation for '{}' returned null: {}", spel, e.getMessage());
      return null;
    }
  }
}
