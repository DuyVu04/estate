...
/**
 * Factory class responsible for resolving the appropriate WorkflowStrategy for a given ReservationAction.
 * Uses Map-based resolution powered by Spring Dependency Injection to eliminate if-else chains.
 */
@Component
