...
/**
 * Context holding runtime execution data of the current Workflow in ThreadLocal. Must ALWAYS be
 * cleared in a finally block to prevent ThreadLocal memory leaks in Thread Pools.
 */
@Data
@Builder
