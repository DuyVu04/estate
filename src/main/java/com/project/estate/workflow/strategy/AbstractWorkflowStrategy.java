...
public abstract class AbstractWorkflowStrategy implements WorkflowStrategy {
    ...
    @Autowired
    protected WorkflowPersistenceService persistenceService;

    @Autowired
    protected SpelEvaluator spelEvaluator;

    @Override
    public void beforeProcess(JoinPoint joinPoint, String stepName, String workflowName, String targetIdSpel) {
        ...
        ReservationActor actor = (existingCtx != null && existingCtx.getActor() != null) ? existingCtx.getActor() : getDefaultActor();
