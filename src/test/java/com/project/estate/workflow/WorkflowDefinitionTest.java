...
class WorkflowDefinitionTest {
    ...
    void getDefinition_ReservationWorkflow_Success() {
        Optional<WorkflowDefinition> defOpt = registry.getDefinition(WorkflowDefinitionRegistry.RESERVATION_WORKFLOW);
    ...
    void findStepByAction_Create_Success() {
        WorkflowDefinition definition = registry.getDefinition(WorkflowDefinitionRegistry.RESERVATION_WORKFLOW).orElseThrow();

        Optional<WorkflowStepDefinition> stepOpt = definition.findStepByAction(ReservationAction.CREATE);
