...
class WorkflowAspectTest {
  ...
  @Test
  @DisplayName(
      "Should intercept Exception thrown by business method and record FAILED history in independent transaction")
  void interceptException_RecordsFailedWorkflowHistory() {
    ...
    RuntimeException ex =
        assertThrows(
            RuntimeException.class, () -> proxiedService.failingCancelReservation("res-003"));
